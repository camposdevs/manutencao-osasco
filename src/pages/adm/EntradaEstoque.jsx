    ...
    <div className="flex min-h-screen bg-[#F8F9FA] text-gray-800 font-sans">
      <aside className="w-64 bg-white border-r border-gray-200 flex flex-col sticky top-0 h-screen">
        ...
        <nav className="flex-1 px-4 space-y-1 overflow-y-auto">
          ...
          <NavItem icon={<ArrowDownToLine size={20} />} label="Entrada de Estoque" active onClick={() => navigate('/admin/entrada-estoque')} />
      ...
      <main className="flex-1 flex flex-col">
        ...
        <div className="p-8">
          <div className="mb-8">
            <h1 className="text-2xl font-bold text-gray-900 leading-tight">Entrada de Estoque</h1>
            <p className="text-gray-500 text-sm">Registre a entrada de materiais no estoque.</p>
          </div>
          ...
          <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden max-w-5xl">
            <div className="p-8 grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <Input label="Quantidade" placeholder="Ex: 20" type="number" />
              <Input label="Fornecedor / Origem" placeholder="Ex: Almoxarifado Central" />
              <Input label="Data da Entrada" placeholder="Ex: 12/06/2026" />
