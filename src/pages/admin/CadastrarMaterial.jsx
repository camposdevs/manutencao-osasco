    ...
    <div className="flex min-h-screen bg-[#F8F9FA] text-gray-800 font-sans">
      <aside className="w-64 bg-white border-r border-gray-200 flex flex-col sticky top-0 h-screen">
        ...
        <nav className="flex-1 px-4 space-y-1 overflow-y-auto">
          ...
          <NavItem icon={<Boxes size={20} />} label="Cadastrar Material" active onClick={() => navigate('/admin/cadastrar-material')} />
      ...
      <main className="flex-1 flex flex-col">
        ...
        <div className="p-8">
          <div className="mb-8">
            <h1 className="text-2xl font-bold text-gray-900 leading-tight">Cadastrar Material</h1>
            <p className="text-gray-500 text-sm">Cadastre um novo material no estoque.</p>
          </div>

          <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden max-w-5xl">
            <div className="p-8 grid grid-cols-1 lg:grid-cols-2 gap-6">
              <Input label="Código do material" placeholder="Ex: MAT001" />
              <Input label="Nome do material" placeholder="Ex: Fita Isolante 20m" />

              <div>
                <label className="text-[11px] font-bold text-gray-400 mb-1.5 block uppercase tracking-wider">Categoria</label>
              ...
              <Input label="Unidade de medida" placeholder="Ex: Unidade, Caixa, Metro, Litro" />
              <Input label="Estoque mínimo" placeholder="Ex: 10" type="number" />
              <Input label="Quantidade inicial" placeholder="Ex: 50" type="number" />

              <div className="lg:col-span-2">
                <label className="text-[11px] font-bold text-gray-400 mb-1.5 block uppercase tracking-wider">Descrição</label>
                <textarea
                  rows="4"
                  placeholder="Descrição ou observação do material..."
            ...
            <div className="p-6 bg-gray-50 border-t border-gray-100 flex justify-end gap-3">
              <button onClick={() => navigate('/admin/materiais')} className="px-6 py-3 border border-gray-200 rounded-xl text-gray-600 font-bold text-xs uppercase tracking-wider hover:bg-gray-50 transition-all">
                Cancelar
              </button>
