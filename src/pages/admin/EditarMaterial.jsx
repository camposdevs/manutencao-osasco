    ...
    <div className="flex min-h-screen bg-[#F8F9FA] text-gray-800 font-sans">
      <aside className="w-64 bg-white border-r border-gray-200 flex flex-col sticky top-0 h-screen">
        ...
        <nav className="flex-1 px-4 space-y-1 overflow-y-auto">
          ...
          <NavItem icon={<Boxes size={20} />} label="Materiais" active onClick={() => navigate('/admin/materiais')} />
      ...
      <main className="flex-1 flex flex-col">
        ...
        <div className="p-8">
          <div className="mb-8">
            <h1 className="text-2xl font-bold text-gray-900 leading-tight">Editar Material</h1>
            <p className="text-gray-500 text-sm">Atualize as informações do material selecionado.</p>
          </div>

          <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden max-w-5xl">
            <div className="p-8 grid grid-cols-1 lg:grid-cols-2 gap-6">
              <Input label="Código do material" value="MAT001" />
              <Input label="Nome do material" value="Luva de Proteção" />
              ...
              <Input label="Unidade de medida" value="Unidade" />
              <Input label="Estoque mínimo" value="50" type="number" />
              <Input label="Quantidade atual" value="45" type="number" />

              <div className="lg:col-span-2">
                <label className="text-[11px] font-bold text-gray-400 mb-1.5 block uppercase tracking-wider">Descrição</label>
                <textarea
                  rows="4"
                  defaultValue="Material utilizado para proteção nas atividades de manutenção."
