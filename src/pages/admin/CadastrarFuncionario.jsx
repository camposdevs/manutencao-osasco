    ...
    <div className="flex min-h-screen bg-[#F8F9FA] text-gray-800 font-sans">
      <aside className="w-64 bg-white border-r border-gray-200 flex flex-col sticky top-0 h-screen">
        ...
        <nav className="flex-1 px-4 space-y-1 overflow-y-auto">
          ...
          <NavItem icon={<Users size={20} />} label="Cadastrar Funcionário" active onClick={() => navigate('/admin/cadastrar-funcionario')} />
      ...
      <main className="flex-1 flex flex-col">
        ...
        <div className="p-8">
          <div className="mb-8">
            <h1 className="text-2xl font-bold text-gray-900 leading-tight">Cadastrar Funcionário</h1>
            <p className="text-gray-500 text-sm">Preencha os dados do novo funcionário.</p>
          </div>
          ...
          <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden max-w-5xl">
            <div className="p-8 grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <Input label="NIF" placeholder="Ex: 25163129" />
              <Input label="E-mail" placeholder="email@exemplo.com" />
              <Input label="Cargo" placeholder="Ex: Manutenção" />

              <div>
                <label className="text-[11px] font-bold text-gray-400 mb-1.5 block uppercase tracking-wider">Tipo de usuário</label>
              ...
              <div>
                <label className="text-[11px] font-bold text-gray-400 mb-1.5 block uppercase tracking-wider">Status</label>
                <select className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-sm outline-none focus:ring-2 focus:ring-red-100 focus:border-red-500 transition-all">
                  <option>Ativo</option>
            ...
            <div className="p-6 bg-gray-50 border-t border-gray-100 flex justify-end gap-3">
              <button onClick={() => navigate('/admin/funcionarios')} className="px-6 py-3 border border-gray-200 rounded-xl text-gray-600 font-bold text-xs uppercase tracking-wider hover:bg-gray-50 transition-all">
                Cancelar
              </button>
...
const Input = ({ label, placeholder }) => (
  <div>
    ...
    <input type="text" placeholder={placeholder} className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-sm outline-none focus:ring-2 focus:ring-red-100 focus:border-red-500 transition-all" />
  </div>
);
